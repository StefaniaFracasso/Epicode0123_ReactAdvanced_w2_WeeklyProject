  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=${props.cityName}&appid=1f16fe96fb700f5d415be8269b8973f6`
      );
      ...
      const forecastResponse = await fetch(
        `https://api.openweathermap.org/data/2.5/forecast?q=${props.cityName}&appid=1f16fe96fb700f5d415be8269b8973f6`
      );
      ...
      <Container className="weatherCard mb-2">
        <Row className="d-flex">
          <Col xs={12} md={6} className="d-flex flex-column">
            ...
            <h4 className="text-secondary">{props.cityName}, {country}</h4>
